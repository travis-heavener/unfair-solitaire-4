...
import { playSound, lockAnimations, unlockAnimations, animateCardElemMove, uncoverTopOfColumn, isAnimLocked, getOverlappingElements, canStackOnElem, updateHistoryState, getCardIndexFromElem, saveHistoryState, checkForAutocomplete, checkForWinCondition } from "./toolbox.mjs";
export class Card {
    suit;
    value;
            ...
            if (doAnimation) {
                ...
                setTimeout(() => {
                    ...
                    if (getHandicapID() === 7 && this.value === "Fish") { // Fish card
                        ...
                        // Animate
                        animateCardElemMove(this.element, $("#fish-spot")[0])
                            .then(() => res());
