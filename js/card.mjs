...
import { animateCardElemMove, canStackOnElem, checkForAutocomplete, checkForWinCondition, getCardIndexFromElem, getOverlappingElements, isAnimLocked, lockAnimations, playSound, restartGame, saveHistoryState, uncoverTopOfColumn, unlockAnimations, updateHistoryState, wait } from "./toolbox.mjs";
export class Card {
    suit;
    value;
    ...
    constructor(suit, value) {
        ...
        switch (getHandicapID()) {
            ...
            case 13: // No values
                ...
                break;
            case 22: // All 8s
                this.element = $($.parseHTML(`<div class="card no-select ${this.suit}"><p>8</p><img src="res/images/${this.suit}-icon.png"></div>`))[0];
                break;
            default:
    ...
    isInTableau() { return $(this.element.parentElement).hasClass("tableau"); }
    // Setters
    setValue(value) {
        this.value = value;
                        ...
                        if (this.is7ofSpades()) {
                            ...
                            wait(150).then(() => {
                                ...
                                setTimeout(() => {
                                    ...
                                    while (isAnimLocked())
                                        unlockAnimations(); // Remove animation locks
                                    restartGame();
                                    _res();
                                }, 4000);
                            });
